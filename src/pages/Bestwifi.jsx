...
const Bestwifi = () => {
  return (
    <>
      <div className="bg-gray-50 min-h-screen flex items-center justify-center mt-[-180px]">
        <div className="container mx-auto p-4">
          <div className="flex flex-col lg:flex-row bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div className="lg:w-1/2">
              <img
                src="https://g2u-wp-prod.s3-ap-southeast-2.amazonaws.com/wp-content/uploads/2023/02/Geeks2U_SpinachAD_CraigMoodiePhoto3546.jpg"
                alt="TV Mounting"
            ...
            <div className="lg:w-1/2 p-8 ml-[23px]">
              <h1 className="text-[32px] mb-2 font-sans">Wifi & Network</h1>
              ...
              <ul className="text-gray-700 text-[14px] space-y-2 font-sans">
                <li>✓ Install a bracket and mount a Wifi & Network between 3" - 9" in size.</li>
