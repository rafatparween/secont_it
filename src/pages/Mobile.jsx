...
const Mobile = () => {
  return (
    <>
      <div className="bg-gray-50 min-h-screen flex items-center justify-center mt-[-163px]">
        <div className="container mx-auto p-4">
          <div className="flex flex-col lg:flex-row bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div className="lg:w-1/2">
              <img
                src="https://www.metrofax.com/wp-content/uploads/2023/12/what-is-a-fax-number-scaled.jpeg"
                alt="TV Mounting"
            ...
            <div className="lg:w-1/2 p-8 ml-[23px]">
              <h1 className="text-[32px] mb-2 font-sans">Printer</h1>
              ...
              <ul className="text-gray-700 text-[14px] space-y-2 font-sans">
                <li>✓ Install a bracket and mount one TV, between 33'' - 60'' in size</li>
