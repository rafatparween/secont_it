...
const Audio = () => {
  return (
    <>
      <div className="bg-gray-50 min-h-screen flex items-center justify-center mt-[-150px]">
        <div className="container mx-auto p-4">
          <div className="flex flex-col lg:flex-row bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div className="lg:w-1/2">
              <img
                src="https://preview.redd.it/x76aqnamq7381.jpg?width=640&crop=smart&auto=webp&s=060e11e548e161ca6b3b7143067ff0cd8b6f5e12"
                alt="TV Mounting"
            ...
            <div className="lg:w-1/2 p-8 ml-[23px]">
              <h1 className="text-[32px] mb-2 font-sans">Audio & Video</h1>
              ...
              <ul className="text-gray-700 text-[14px] space-y-2 font-sans">
                <li>✓ Install a bracket and mount a tablet between 4" - 8" in size.</li>
