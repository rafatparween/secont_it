        ...
        <div className="container mx-auto p-4">
          <div className="flex flex-col lg:flex-row bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div className="lg:w-1/2">
              <img
                src="https://media.istockphoto.com/id/1159673542/photo/businesswoman-using-scanner-in-office.jpg?s=612x612&w=0&k=20&c=t3YAPYaMmL37rTchTyk7aYUGcvcnnPh4P26QSppLBB0="
                alt="TV Mounting"
