...
const Bestcomputer = () => {
  return (
    <>
      <div className="bg-gray-50 min-h-screen flex items-center justify-center mt-[-70px]">
        <div className="container mx-auto p-4">
          <div className="flex flex-col lg:flex-row bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div className="lg:w-1/2">
              <img
                src="https://img.freepik.com/premium-photo/man-woman-working-computer-with-laptop-front-them_662214-718526.jpg"
                alt="TV Mounting"
            ...
            <div className="lg:w-1/2 p-8 ml-[23px]">
              <h1 className="text-[32px] mb-2 font-sans">Computer Support</h1>
              ...
              <ul className="text-gray-700 text-[14px] space-y-2 font-sans">
                <li>✓ Install a bracket and mount a Computer between 7" - 12" in size.</li>
      ...
      <div className="absolute bottom-0 left-0 right-0 flex justify-around bg-blue-500 py-4 mb-[-19px]">
